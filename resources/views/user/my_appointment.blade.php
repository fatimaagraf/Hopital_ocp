...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary"> <img class="ocp-logo" src="../assets/img/icon.png" alt="ocp"></span></a>
...
@foreach($appoint as $appoints)
        <tr style="background-color:white;"align="center">
            ...
            <td> <a class="bt btn-danger" onclick="return confirm('are you sure to delet' )"
